        ...
        <div class="py-8">
            <div class="mx-auto max-w-4xl space-y-4 px-4 sm:px-6 lg:px-8">
                ...
                <div class="rounded-lg bg-white p-4 shadow">
                    ...
                    <pre class="whitespace-pre-wrap break-words text-sm">{{ prompt ?? 'This body has been purged by the retention policy.' }}</pre>
                </div>

                <div class="rounded-lg bg-white p-4 shadow">
                    <h3 class="mb-2 font-semibold">Answer</h3>
                    <pre class="whitespace-pre-wrap break-words text-sm">{{ answer ?? 'This body has been purged by the retention policy.' }}</pre>
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
